...
记录一下t中字符和其频率，然后随着end的变大不停更新这个maps，即出现一个字符，
如果该字符在maps里面，我们就对应的自减一下这个字符在maps中的频率
...
当最后while end < len(s)循环出来的时候，我们判断一下我们的window的length是不是变化了（最开始设置了inf最大值），
如果变化了说明我们找到了符合要求的window，否则没有
"""
